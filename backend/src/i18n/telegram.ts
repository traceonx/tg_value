...
export const resources = {
    'zh-CN': {
        ...
        'bot.link.reuseFolder': '10 分钟内你使用过目录「{folder}」。是否沿用？\n选择“否”将保存到日期目录「{date}」。',
        'bot.link.folderYes': '是，沿用上次目录',
        'bot.link.folderNo': '否，使用日期目录',
        'bot.link.folderSelected': '📁 本次保存目录：{folder}',
        'bot.link.folderExpired': '此选择已失效或不属于你，请重新发送链接。',
        'folderBrowser.title': '📁 文件夹：{folder}',
        'bot.comments.title': '🎬 评论视频：本页发现 {count} 个（检查了 {scanned} 条评论）',
        ...
        'bot.comments.expired': '选择已使用、已过期或不属于你，请重新发送帖子链接。',
        'bot.comments.cancelled': '已取消本次选择，未开始下载。',
        'bot.comments.loading': '正在检查更早的评论…',
        'bot.comments.selected': '已选择，正在提交下载任务…',
        'folderBrowser.page': '第 {page} / {total} 页 · 点击文件夹进入，点击复制按钮复制目录名称',
        'folderBrowser.copy': '📋 复制文件夹名',
        ...
        'menu.file_concurrency': '文件级下载并发',
        'menu.duplicate_mode': '重复文件处理',
        'menu.setup_2fa': '设置双重验证',
        'menu.logout': '退出登录',
    ...
    en: {
        ...
        'bot.link.reuseFolder': 'You used “{folder}” within the last 10 minutes. Reuse it?\nChoose No to use the date folder “{date}”.',
        'bot.link.folderYes': 'Yes, reuse folder',
        'bot.link.folderNo': 'No, use date folder',
        'bot.link.folderSelected': '📁 Save this download to: {folder}',
        'bot.link.folderExpired': 'This choice expired or belongs to another user. Send the link again.',
        'folderBrowser.title': '📁 Folder: {folder}',
        'bot.comments.title': '🎬 Comment videos: {count} found on this page ({scanned} comments checked)',
        ...
        'bot.comments.expired': 'This selection was used, expired or belongs to someone else. Send the post link again.',
        'bot.comments.cancelled': 'Selection cancelled. No download started.',
        'bot.comments.loading': 'Checking older comments…',
        'bot.comments.selected': 'Selected. Submitting the download…',
        'folderBrowser.page': 'Page {page} / {total} · Open a folder or copy its name',
        'folderBrowser.copy': '📋 Copy folder name',
        ...
        'menu.file_concurrency': 'Parallel file downloads',
        'menu.duplicate_mode': 'Duplicate file handling',
        'menu.setup_2fa': 'Set up two-factor authentication',
        'menu.logout': 'Log out',
